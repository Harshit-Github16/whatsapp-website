...
// Next.js 15 Metadata Generator for SEO
      ...
      <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col items-center justify-center p-6 text-center font-sans">
        <div className="bg-slate-900 border border-slate-800 rounded-3xl p-8 max-w-md w-full shadow-2xl flex flex-col items-center gap-4">
          ...
          <p className="text-sm text-slate-400 leading-relaxed">
            The subdomain <code className="bg-slate-950 px-1.5 py-0.5 rounded text-emerald-400 font-mono text-xs">{subdomain}</code> has not been claimed or registered yet.
          </p>
