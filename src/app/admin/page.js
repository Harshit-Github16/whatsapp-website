          ...
          <div className="flex border-b border-slate-200 px-2 py-1.5 gap-1 shrink-0 bg-white shadow-sm">
            {[
              ...
              <button
                ...
                className={`flex-1 flex flex-col items-center gap-1 py-2 px-1 rounded-xl text-[10px] font-bold tracking-wide transition-all cursor-pointer ${activeTab === id
                ...
                <div className="grid grid-cols-1 gap-3">
                  {[
                    ...
                    <button
                      ...
                      className={`p-4.5 rounded-2xl border text-left flex items-start gap-4 transition-all cursor-pointer ${businessData.theme === t.id
